...
df = pd.read_csv("bt_batch_06.csv", encoding="utf-8-sig")

st.set_page_config(page_title="Backtranslation Rating - Rater 06", layout="centered")
st.title("📝 Simplification Back-Translation Evaluation - Rater 06")
...
if st.button("💾 Export Ratings to CSV"):
    pd.DataFrame(ratings).to_csv(f"bt_ratings_rater06.csv", index=False, encoding="utf-8-sig")
